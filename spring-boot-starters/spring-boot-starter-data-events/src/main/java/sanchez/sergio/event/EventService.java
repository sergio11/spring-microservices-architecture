...
public interface EventService<T extends Event, ID extends Serializable> {
    ...
    /**
     * Raises a synchronous domain event. An {@link Event} will be applied to an
     * entity through a chain of HTTP requests/responses.
     *
    ...
    /**
     * Raises an asynchronous domain event. An {@link Event} will be applied to
     * an entity through a chain of AMQP messages.
     *
     * @return a flag indicating if the {@link Event} message was sent
     * successfully
     */
    <S extends T> Boolean sendAsync(S event, Link... links);

    /**
     * Saves a given event entity. Use the returned instance for further
     ...
     * Saves a given event entity. Use the returned instance for further
     * operations as the save operation might have changed the entity instance
     * completely. The {@link ID} parameter is the unique {@link Event}
     * identifier.
     *
     * @return the saved event entity
     */
     ...
     *
     * @return the {@link Event} entity with the given id or {@literal null} if
     * none found
     */
