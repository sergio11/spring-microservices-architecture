...
public class UnarchiveAccountFunction extends AccountFunction {
    ...
    public UnarchiveAccountFunction(StateContext<AccountStatus, AccountEventType> context){
        this(context, null);
    }

    public UnarchiveAccountFunction(StateContext<AccountStatus, AccountEventType> context, Function<AccountEvent, Account> lambda) {
