...
public class UnSuspendAccountFunction extends AccountFunction {
    ...
    public UnSuspendAccountFunction(StateContext<AccountStatus, AccountEventType> context){
        this(context, null);
    }

    public UnSuspendAccountFunction(StateContext<AccountStatus, AccountEventType> context, Function<AccountEvent, Account> lambda) {
